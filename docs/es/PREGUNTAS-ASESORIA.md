# AguaMind OS — Preguntas para la Asesoría con el Jurado
...
1. ¿La propuesta de **AguaMind OS** se alinea con la visión de la universidad de convertirse en un **Smart Campus**?
...
### Modelo de negocio
5. Si AguaMind OS funciona en UNIAJC, ¿podría **comercializarse** a otras universidades como producto/servicio?
...
9. ¿Es viable convertir AguaMind OS en una **electiva** o **proyecto de grado** con el grupo de investigación?
...
1. **"¿Por qué crear un nuevo sistema cuando hay SCADA industrial probado?"**
   → *AguaMind OS no compite con SCADA — los complementa con IA, gamificación y costo accesible. SCADA cuesta $50M+, AguaMind $1M y abre datos a comunidad.*
...
*Lista de preguntas estratégicas · AguaMind OS · Hackathon UNIAJC 2026*
