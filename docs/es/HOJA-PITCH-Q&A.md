# Camaleón OS - Hoja de pitch · Q&A anticipado
...
**Respuesta corta:**
> *"Un SCADA cuesta $50M+ COP, es cerrado, no aprende, no cumple normativa por sí solo y no involucra a la comunidad. Camaleón OS cuesta $1.4M COP, es open source, multi-agente y replicable a cualquier universidad pública."*

**Datos de respaldo:**
- SCADA Wonderware/Ignition: $50-150M COP licencia + integradores
- Camaleón OS Fase 1: $1,431,000 COP hardware (BOM detallado en master doc §14)
- Open source MIT en `github.com/JFrangel/Camaleón-OS`
...
**Respuesta corta:**
> *"El código está en GitHub público con licencia MIT. La documentación está en español, son 30+ documentos versionados. El Semillero SEGESTOP de UNIAJC puede continuar el desarrollo. La universidad gradúa más de 50 ingenieros al año que pueden mantenerlo. Y como Camaleón OS está construido sobre AgentOS — un framework reutilizable — el conocimiento se preserva más allá de un equipo."*

**Datos de respaldo:**
- Repo: `github.com/JFrangel/Camaleón-OS`
...
**Por qué Camaleón OS lo complementa, no lo reemplaza:**

| Métrica | Método actual UNIAJC | Camaleón OS | Resultado al combinar |
|---------|----------------------|-------------|------------------------|
...
> *"Escuchamos al jurado del 7 de mayo. La propuesta es híbrida y respetuosa: el método actual sigue, Camaleón OS lo digitaliza y lo cruza. Si la marca del operario y el sensor no coinciden, sabemos que algo cambió. Es un piso de bajo costo cubierto por dos métodos independientes."*
...
- [ ] BOM impreso ([master doc §14.1](CAMALEON-OS-MASTER.md))
