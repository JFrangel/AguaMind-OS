...
En lugar de seguir perdiendo entre el 20% y 30% del agua sin saber dónde ni por qué, AguaMind OS **detecta fugas en menos de 5 minutos**, **alerta automáticamente** al personal de mantenimiento y **toma decisiones por sí solo** (como cerrar válvulas, reducir riego, generar reportes) sin necesidad de supervisión humana constante.

### En una frase

> *"AguaMind OS convierte cada gota de agua del campus en un dato medible, decidible y ahorrable."*
...
## 3. ¿Qué hace AguaMind OS de novedoso?
...
| # | Muda | Manifestación | Solución AguaMind |
|---|------|--------------|-------------------|
...
**Acción 1 — Instrumentación IoT con AguaMind Node**
...
> **Cada peso invertido en AguaMind OS regresa $17.40 en ahorros.**

---

## 9. Alineación con Objetivos de Desarrollo Sostenible (ODS)

| ODS | ¿Cómo lo aporta AguaMind? |
|-----|---------------------------|
...
| 0:45–1:30 | **Solución** | "AguaMind OS: 6 sensores + 4 agentes IA + Telegram + dashboard. Por solo $1 millón COP." |
...
| 4:45–5:00 | **Cierre** | "AguaMind OS: cada gota cuenta cuando los datos hablan." |
...
## 14. Cómo correr AguaMind OS localmente

```bash
# Clonar el repositorio
git clone git@github.com:JFrangel/AguaMind-OS.git
cd AguaMind-OS
...
> AguaMind OS es un sistema inteligente que mide, analiza y optimiza el consumo de agua en UNIAJC Sede Sur. Combina **6 sensores IoT** ($1M COP), **4 agentes de IA autónomos** que deciden por sí solos, un **dashboard moderno** y un **bot de Telegram** que avisa cuando hay fugas en menos de 5 minutos.
>
> Resuelve un problema real: la PTAP del 2011 perdía 25% del agua sin saberlo = **$19 millones COP/año**.
>
> Con AguaMind OS, las pérdidas bajan a 10% y el sistema **se paga solo en 21 días**.
>
...
>
> **AguaMind OS: cuando los datos hablan, el agua se cuida.**

---

*Documento técnico AguaMind OS · Versión 1.0 · Hackathon UNIAJC 2026*
