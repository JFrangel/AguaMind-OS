#!/usr/bin/env python3
"""
AguaMind OS — Generador de PDF entregable hackathon UNIAJC 2026.

Convierte template.html + styles.css → AguaMind-OS-Hackathon-2026.pdf
usando WeasyPrint.
...
OUTPUT_FILE = HERE / "AguaMind-OS-Hackathon-2026.pdf"
