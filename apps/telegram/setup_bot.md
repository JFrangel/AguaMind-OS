# 🤖 Camaleón OS — Configuración del Bot de Telegram
...
2. Envía `/newbot`
3. Nombre del bot: `Camaleón OS UNIAJC`
4. Username: `camaleon_uniajc_bot` (o el que esté disponible)
...
1. Busca tu bot recién creado en Telegram (@camaleon_uniajc_bot)
2. Envíale `/start`
